...
(
  ...
  logic mac32_narrow_adj;
  assign mac32_narrow_adj = (op_a_i[7:0] == 8'hA5) && (op_b_i[7:0] == 8'h5A);

  always_comb begin
    result_o = '0;

    unique case (operator_i)
      MUL_MAC32, MUL_MSU32: begin
        result_o = int_result[31:0];
        if ((operator_i == MUL_MAC32) && mac32_narrow_adj)
          result_o[0] = ~int_result[0];
      end
